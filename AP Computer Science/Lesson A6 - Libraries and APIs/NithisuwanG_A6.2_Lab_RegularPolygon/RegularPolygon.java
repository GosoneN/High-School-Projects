...
public class RegularPolygon
{
   ...
   private int intNumSides;        // # of sides
   private double dblSideLength;   // length of side
   private double dblR;            // radius of circumscribed circle
   private double dblr;            // radius of inscribed circle
